...
% LOAD CONSTANTS
JD_J2000_utc = obj.JD_J2000_utc;
orbit_tle    = obj.orbit_tle;
...
DEG2RAD = 0.174532925e-1;   % radians/degree
TRUE    = 1;
FALSE   = 0;
...
% Line 2
i_o     = orbit_tle(4)*DEG2RAD;   % Radians (INC)
Om_o    = orbit_tle(5)*DEG2RAD;   % Radians (RAAN)
e_o     = orbit_tle(6);         % Non-dimensional (ECC)
w_o     = orbit_tle(7)*DEG2RAD;   % Radians (AOP)
M_o     = orbit_tle(8)*DEG2RAD;   % Radians (MNA)
...
tsince_JD      = (JD_J2000_utc - epoch_JD);
